...
| `DCEMU_JIT_SIN_PAR_RTS=1` | apaga el par de retorno (`rts` + ranura con memoria) y reproduce la frontera anterior al dígito. El par viene **encendido**: cobertura +2,5/+2,8 pt, entradas −9,6/−12,7 %, tiempo mixto-marginal (DOOM/CT mejor, SR2 −0,8 pt); el par **termina la traza** — dejar la cola le costó a SR2 dos puntos y +27 % de arena |
