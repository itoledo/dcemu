# La tanda de la verificacion por generacion de onda del ARM7: DOS brazos sobre el mismo
# binario -- con (por omision) y sin (DCEMU_SIN_VERIF_ONDA=1, el memcmp en
# cada salto) -- bajo el traductor, que es la forma que la adopcion entrega.
...
Remove-Item env:DCEMU_JIT,env:DCEMU_SIN_VERIF_ONDA,env:DCEMU_PULSAR_START,env:DCEMU_PULSAR_A,env:DCEMU_SOLO_A -EA SilentlyContinue
Write-Output "=== fin"
