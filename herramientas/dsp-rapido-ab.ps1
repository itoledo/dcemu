# La tanda de la cuerpo rapido del DSP (aicadsp.c): DOS brazos sobre el mismo
# binario -- con (por omision) y sin (DCEMU_SIN_DSP_RAPIDO=1, los 128 pasos de siempre) -- bajo el traductor, que es la forma que la adopcion entrega.
...
Remove-Item env:DCEMU_JIT,env:DCEMU_SIN_DSP_RAPIDO,env:DCEMU_PULSAR_START,env:DCEMU_PULSAR_A,env:DCEMU_SOLO_A -EA SilentlyContinue
Write-Output "=== fin"
