# La tanda de la encadenado emitido del ARM7 (arm7jit.c): DOS brazos sobre el mismo
# binario -- con (por omision) y sin (DCEMU_SIN_CADENA_ARM=1, los 128 pasos de siempre) -- bajo el traductor, que es la forma que la adopcion entrega.
...
Remove-Item env:DCEMU_JIT,env:DCEMU_SIN_CADENA_ARM,env:DCEMU_PULSAR_START,env:DCEMU_PULSAR_A,env:DCEMU_SOLO_A -EA SilentlyContinue
Write-Output "=== fin"
