# La tanda del microprograma del DSP emitido (aicadspjit.c): DOS brazos sobre
...
Remove-Item env:DCEMU_JIT,env:DCEMU_SIN_JIT_DSP,env:DCEMU_PULSAR_START,env:DCEMU_PULSAR_A,env:DCEMU_SOLO_A -EA SilentlyContinue
Write-Output "=== fin"
